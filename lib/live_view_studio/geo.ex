defmodule LiveView.Studio.Geo do
  @doc """
  Returns a random lat/lng coordinate within the given radius of a location.
  ...
  def randomMontrealLatLng do
    randomNearbyLatLng(45.5, -73.6, 3)
  end
end
